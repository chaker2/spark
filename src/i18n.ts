...
const fr = {
  ...
  teacher: {
    ...
    welcomeSubtitle: "Créez des quiz, animez des sessions en direct et suivez la progression de votre classe en temps réel.",
    tip1Title: "Créez un quiz", tip1Body: "Ajoutez vos questions et personnalisez chaque partie.",
    tip2Title: "Lancez une partie", tip2Body: "Partagez le code à 5 chiffres avec vos élèves.",
    tip3Title: "Suivez les résultats", tip3Body: "Consultez le classement en direct.",
    hostLabel: "Enseignant", clearPlayers: "Effacer tous les joueurs",
    confirmEnd: "Terminer cette partie ?",
  },
  qtype: {
...
const en: typeof fr = {
  ...
  teacher: {
    ...
    welcomeSubtitle: "Create quizzes, host live sessions and track your class progress in real time.",
    tip1Title: "Create a quiz", tip1Body: "Add your questions and customize every game.",
    tip2Title: "Host a game", tip2Body: "Share the 5-digit code with your students.",
    tip3Title: "Track results", tip3Body: "See the live leaderboard as students answer.",
    hostLabel: "Teacher", clearPlayers: "Remove all players",
...
const ar: typeof fr = {
  ...
  teacher: {
    ...
    welcomeTitle: "أهلاً بك في لوحة التحكم",
    welcomeSubtitle: "أنشئ الاختبارات، أدِر الجلسات المباشرة وتابع تقدم صفك في الوقت الفعلي.",
    tip1Title: "أنشئ اختبارًا", tip1Body: "أضف أسئلتك وخصّص كل لعبة.",
    tip2Title: "أطلق لعبة", tip2Body: "شارك الرمز المكوّن من 5 أرقام مع طلابك.",
    tip3Title: "تابع النتائج", tip3Body: "شاهد التصنيف المباشر أثناء إجابة الطلاب.",
    hostLabel: "المعلم", clearPlayers: "إزالة جميع اللاعبين",
    confirmEnd: "إنهاء هذه اللعبة؟",
  },
  qtype: {
